  ...
  <?php 
   ...
   ?>
       <?php 
            foreach ($goods_infos_view as $gi)
             {
        ?>
                            
                            <!-- <div class="clearfix goodsBox" style="border: medium none; padding: 11px 0pt 10px 5px;"> -->
                                <div class="goodsItem">
                                    <a href="./index.php?r=goods/detail&id=<?php echo $gi->goods_id ?>" target=_blank><img src='<?php echo $gi->goods_big_img ?>' alt='<?php echo $gi->goods_name ?>' class="goodsimg"></a><br />
                                    <p><a href="#" title="<?php echo $gi->goods_name ?>"><?php echo $gi->goods_name ?></a></p>
                                    <font class="market_s">￥<?php echo $gi->goods_price ?>元</font><br />
                                    <font class="shop_s">￥<?php echo $gi->goods_price ?>元</font><br />
